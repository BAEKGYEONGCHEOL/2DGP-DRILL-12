...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        move_to_target_location = Sequence('Move to Target', a1, a2)

        a3 = Action('Set Random Location', self.set_random_location)

        wander = Sequence('Wander', a3, a2)

        # 컨디션 노드와 액션 노드를 생성하여 행동 트리에 추가
        ...
        chase_if_boy_near_or_wander = Selector('소년이 가까이 있으면 소년을 추적 또는 배회', chase_boy_if_nearby, wander)
